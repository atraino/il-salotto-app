...
/** F. Login: bentornata, the room just as she left it. Leads into this month's Porta. */
export function Login({ go }: ScreenProps) {
  ...
  return (
    <Screen tone="green" bodyStyle={{ padding: '30px 34px 26px', alignItems: 'center', textAlign: 'center' }}>
      <PhotoFrame
        tone="green"
      ...
      >
        ...
        <div style={{ margin: '10px 0 0', font: `italic 400 12.5px ${font.serif}`, color: color.mutedGreen }}>
          It leads straight into this month&rsquo;s Porta.
        </div>
      </div>
